...
const productsData = [
  {
    title: "Wheats",
    desc1: "High-quality wheat cultivated with advanced farming techniques for better yield.",
    desc2: "Rich in nutrients and ideal for flour production and daily consumption.",
    img: product1,
  },
  {
  ...
  {
    title: "Native Cattle",
    desc1: "Strong and healthy native breeds raised with natural feeding practices.",
          ...
          <div className="col-lg-6 col-12 text-center">
            <div className="sec-4-txt-1">
              ...
              <p className="sec-subtitle">
                We collaborate with trusted partners to deliver quality and innovation in agriculture.
              </p>
            </div>
          </div>
        </div>
