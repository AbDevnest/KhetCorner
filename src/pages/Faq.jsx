...
function faq() {
  const faqData = [
    ...
    },
    {
      ...
      answer: "Yes, we guide new farmers from planning to harvesting.",
    },
    {
      id: 5,
              ...
              <div className="col-lg-8 col-12">
                <div className="faq-header">
                  ...
                  <p className="text-muted">
                    Find answers to common questions about our agriculture
                    services, farming solutions, and partnerships.
                  </p>
                </div>
                ...
                <div className="faq-aside">
                  ...
                  <div className="aside-box">
                    ...
                    <ul>
                      <li>
                        {" "}
                        Agriculture <span>12</span>
                      </li>
                      <li>
                        {" "}
                        Organic <span>16</span>
                      </li>
                      <li>
                        {" "}
                        Vegetables <span>13</span>
                      </li>
                      <li>
                        {" "}
                        Natural Food <span>10</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="aside-box help-box">
                    ...
                    <p>
                      ...
                      farming solutions and services.
                    </p>
                    <button className="btn-main w-100 mt-4">Contact Us</button>
                  </div>
                </div>
              </div>
            </div>
